package ir.viratech.just_ro.model.calendar;
...
public class CalendarTool {
	 ...
	 static String iraniWeekDayStr[] = {
	    ...
	    public String getPinTaPinGregorianDate() {
	        return (gYear + "/" + 0 + gMonth + "/" + gDay);
	    }
	    ...
	    /*
	     * Added by Amir Hosein Khalouei
	     */
		public String getIranianToday() {
			String[] todayParts = getIranianDate().split("/");
			int year = Integer.parseInt(todayParts[0]);
			int month = Integer.parseInt(todayParts[1]);
			int day = Integer.parseInt(todayParts[2]);
			String today = year + "/";
			if (month < 10)
				today = today + "0" + month + "/";
			else
		...
		public String getCurrentTime(String simpleDateFormat) {
