...
/**
 * A base DTO for class "Gradient".
 * Do not edit this file.
 * It is an automatically generated class.
 *
 */
public abstract class BaseGradientLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<Gradient> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "GradientLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<GradientLightDTO> {
		...
		/**
		 * Creates a DTO of type "GradientLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public GradientLightDTO createDto() {
			return new GradientLightDTO();
		}
	 ...
	 */
	public GradientLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(GradientLightDTO.FieldInfoContext.class);
	}
	...
	/**
	 * Loads this DTO from an entity object of type "Gradient".
	 * 
	 * @param gradient the entity object from which this DTO is loaded. 
	 */
	@Override
	public void loadFrom(Gradient gradient) {
		this.uid = gradient.getExtuid();
		this.title = gradient.getTitle();
	}
	
	/**
	 * Saves this DTO to an entity object of type "Gradient".
	 * 
	 * @param gradient the entity object to which this DTO is saved. 
	 * @throws BadDtoEntityModificationException If this DTO is not valid for saving. 
	 */
	@Override
	public void saveTo(Gradient gradient) throws ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException {
		//Disabled save for property: uid
		gradient.setTitle(this.title);
	}
