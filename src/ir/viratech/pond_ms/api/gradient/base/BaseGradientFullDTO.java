 ...
 *
 */
public abstract class BaseGradientFullDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<Gradient> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "GradientFullDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<GradientFullDTO> {
		...
		/**
		 * Creates a DTO of type "GradientFullDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public GradientFullDTO createDto() {
			return new GradientFullDTO();
		}
	 ...
	 */
	public GradientFullDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(GradientFullDTO.FieldInfoContext.class);
	}
