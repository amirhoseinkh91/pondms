...
import ir.viratech.pond_ms.api.map_object.vector.dto.PointObjectLightDTO;
 ...
 *
 */
public abstract class BasePointObjectLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<PointObject> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "PointObjectLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<PointObjectLightDTO> {
		...
		/**
		 * Creates a DTO of type "PointObjectLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public PointObjectLightDTO createDto() {
			return new PointObjectLightDTO();
		}
	 ...
	 */
	public PointObjectLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(PointObjectLightDTO.FieldInfoContext.class);
	}
