...
import ir.viratech.pond_ms.api.map_object.vector.dto.PolygonObjectLightDTO;
 ...
 *
 */
public abstract class BasePolygonObjectLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<PolygonObject> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "PolygonObjectLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<PolygonObjectLightDTO> {
		...
		/**
		 * Creates a DTO of type "PolygonObjectLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public PolygonObjectLightDTO createDto() {
			return new PolygonObjectLightDTO();
		}
	 ...
	 */
	public PolygonObjectLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(PolygonObjectLightDTO.FieldInfoContext.class);
	}
	...
	public void saveTo(PolygonObject polygonObject) throws ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException {
		...
		polygonObject.setName(this.name);
	}
