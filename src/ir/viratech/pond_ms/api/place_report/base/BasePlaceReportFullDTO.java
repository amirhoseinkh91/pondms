...
import ir.viratech.pond_ms.api.place_report.dto.PlaceReportFullDTO;
 ...
 *
 */
public abstract class BasePlaceReportFullDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<PlaceReport> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "PlaceReportFullDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<PlaceReportFullDTO> {
		...
		/**
		 * Creates a DTO of type "PlaceReportFullDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public PlaceReportFullDTO createDto() {
			return new PlaceReportFullDTO();
		}
	 ...
	 */
	public PlaceReportFullDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(PlaceReportFullDTO.FieldInfoContext.class);
	}
	...
	public void loadFrom(PlaceReport placeReport) {
		...
		this.creationDate = placeReport.getCreationDate();
	}
