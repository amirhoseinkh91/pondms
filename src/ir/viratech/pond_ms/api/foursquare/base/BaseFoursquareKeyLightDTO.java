...
import ir.viratech.pond_ms.api.foursquare.dto.FoursquareKeyLightDTO;
 ...
 *
 */
public abstract class BaseFoursquareKeyLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<FoursquareKey> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "FoursquareKeyLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<FoursquareKeyLightDTO> {
		...
		/**
		 * Creates a DTO of type "FoursquareKeyLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public FoursquareKeyLightDTO createDto() {
			return new FoursquareKeyLightDTO();
		}
	 ...
	 */
	public FoursquareKeyLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(FoursquareKeyLightDTO.FieldInfoContext.class);
	}
