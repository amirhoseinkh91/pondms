...
import ir.viratech.pond_ms.api.user.dto.FeatureDTO;
...
/**
 * A base DTO for class "Feature".
 * Do not edit this file.
 * It is an automatically generated class.
 *
 */
public abstract class BaseFeatureDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<Feature> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "FeatureDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<FeatureDTO> {
		...
		/**
		 * Creates a DTO of type "FeatureDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public FeatureDTO createDto() {
	 ...
	 */
	public FeatureDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(FeatureDTO.FieldInfoContext.class);
	}
	...
	/**
	 * Loads this DTO from an entity object of type "Feature".
	 * 
	 * @param feature the entity object from which this DTO is loaded. 
	 */
	@Override
	public void loadFrom(Feature feature) {
		this.uid = feature.getExtuid();
		this.title = feature.getDisplayString();
	}
	
	/**
	 * Saves this DTO to an entity object of type "Feature".
	 * 
	 * @param feature the entity object to which this DTO is saved. 
	 * @throws BadDtoEntityModificationException If this DTO is not valid for saving. 
	 */
	@Override
	public void saveTo(Feature feature) throws ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException {
