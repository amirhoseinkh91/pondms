 ...
 *
 */
public abstract class BaseTimeSeriesGroupLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<TimeSeriesGroup> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "TimeSeriesGroupLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<TimeSeriesGroupLightDTO> {
		...
		/**
		 * Creates a DTO of type "TimeSeriesGroupLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public TimeSeriesGroupLightDTO createDto() {
			return new TimeSeriesGroupLightDTO();
		}
	 ...
	 */
	public TimeSeriesGroupLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(TimeSeriesGroupLightDTO.FieldInfoContext.class);
	}
