...
import ir.viratech.pond_ms.api.layer.dto.ParentLayerLightDTO;
 ...
 *
 */
public abstract class BaseParentLayerLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<ParentLayer> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "ParentLayerLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<ParentLayerLightDTO> {
		...
		/**
		 * Creates a DTO of type "ParentLayerLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public ParentLayerLightDTO createDto() {
			return new ParentLayerLightDTO();
		}
	 ...
	 */
	public ParentLayerLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(ParentLayerLightDTO.FieldInfoContext.class);
	}
