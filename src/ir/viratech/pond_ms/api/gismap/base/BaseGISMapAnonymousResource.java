...
/**
 *  Base class for "GISMapAnonymousResource".
 *  It is an automatically generated file and should not be edited.
 */
@Api(value = BaseGISMapAnonymousResource.RESOURCE_PATH_BASE, description = BaseGISMapAnonymousResource.RESOURCE_DESCRIPTION)
public abstract class BaseGISMapAnonymousResource extends ir.viratech.pond_ms.api.AbstractMgrBasedResource<GISMap, ir.viratech.pond_ms.api.gismap.dto.GISMapFullDTO> {
	
	/**
	 * The resource path base used in swagger.
	 */
	public static final String RESOURCE_PATH_BASE = "/gis-map"+"/"+PATH_PART_ITEMS;
	 ...
	 */
	public static final String RESOURCE_PATH = "/gis-map"+PATH_PARAM_PART__ITEMS;
	 ...
	 */
	public BaseGISMapAnonymousResource() {
		super();
	}
