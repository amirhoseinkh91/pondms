 ...
 *
 */
public abstract class BaseGISMapLightDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<GISMap> {
	
	
	/**
	 * 
	 * Base FieldInfoContext for "GISMapLightDTO".
	 *
	 */
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<GISMapLightDTO> {
		...
		/**
		 * Creates a DTO of type "GISMapLightDTO".
		 *
		 * @return the created DTO
		 */
		@Override
		public GISMapLightDTO createDto() {
			return new GISMapLightDTO();
		}
	 ...
	 */
	public GISMapLightDTO.FieldInfoContext getFieldInfoContext() {
		return getFieldInfoContextInstance(GISMapLightDTO.FieldInfoContext.class);
	}
