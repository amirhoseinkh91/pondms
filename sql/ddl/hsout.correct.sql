...
not null, collectionName varchar(255) not null, hotkey varchar(255), archive boolean not null, parentEntityTypeId
bigint, docxExportTemplate varchar(255), primary key (id));
create table commons_cm.ENTITY_TYPE_SNAPSHOTS (id bigint not null, extuid varchar(255) not null, entityTypeId
bigint not null, rawJsonSchema text not null, creatorUsername varchar(255), creationDate timestamp not
null, processedJsonSchema text not null, revision bigint not null, primary key (id));
...
null, videoUrl varchar(255), videoOnly boolean not null, primary key (id));
...
key (id));
create table pond_ms.CAMPAIGNS (id bigint not null, extuid varchar(255) not null, useId varchar(255) not
null, phone_num varchar(255) not null, device_name varchar(255), destination varchar(255) not null, day01
char(1), day02 char(1) not null, day03 char(1) not null, day04 char(1) not null, day05 char(1) not null,
day06 char(1) not null, day07 char(1) not null, day08 char(1) not null, day09 char(1) not null, day10
char(1) not null, day11 char(1) not null, day12 char(1) not null, day13 char(1) not null, day14 char(1)
not null, day15 char(1) not null, day16 char(1) not null, day17 char(1) not null, day18 char(1) not null,
primary key (id));
...
phoneNumber varchar(255) not null, email varchar(255), biography varchar(255), name varchar(255), age
varchar(255), gender varchar(255), locality varchar(255), lotteryCode varchar(255) not null, primary key
(id));
...
create table pond_ms.FEED_BACKS (id bigint not null, extuid varchar(255) not null, title varchar(255),
email varchar(255), comment varchar(255) not null, date timestamp not null, primary key (id));
...
creation_date timestamp not null, provider varchar(255), formUID varchar(255), reviewCount bigint, favoriteCount
bigint, layer_id bigint not null, primary key (id));
...
create table pond_ms.PLACE_REPORT (id bigint not null, extuid varchar(255) not null, title varchar(255)
not null, message text not null, creationDate timestamp not null, primary key (id));
...
null, rate bigint not null, text text not null, creationDate timestamp not null, lastModifiedDate timestamp
not null, user_id bigint, visitedDate timestamp not null, typeOfVisit varchar(255) not null, confirmed
bigint not null, deleted boolean not null, vector_object_id bigint, primary key (id));
...
create table pond_ms.ROLE_FEATURES (roleId bigint not null, featureId bigint not null, primary key (roleId,
featureId));
...
create table pond_ms.USERS (id bigint not null, extuid varchar(255) not null, authUserId bigint, enabled
boolean not null, userDefined boolean not null, avatar varchar(255), organizationId bigint, lastSeen timestamp,
firebaseId varchar(255), primary key (id));
...
alter table commons_cm.ENTITY_TYPE_SNAPSHOTS add constraint key_entityType_revision  unique (entityTypeId,
revision);
