...
phoneNumber varchar(255) not null, email varchar(255), biography varchar(255), name varchar(255), primary
key (id));
...
boolean not null, userDefined boolean not null, avatar varchar(255), organizationId bigint, primary key
(id));
