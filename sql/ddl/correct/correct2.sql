...
alter table org_chart.EXTERNAL_ORGANIZATIONS drop constraint FK_ntxniwm3lhdo5p3h5aexe5oke;
alter table org_chart.EXTERNAL_ORGANIZATIONS drop constraint FK_98axcpe1doxdnqxctxuv3e0r5;
alter table org_chart.EXTERNAL_ORGANIZATION_MEMBERS drop constraint FK_31xwmqptsbxmi014lhonmhvye;
alter table org_chart.GROUPS drop constraint FK_owwl9qyccsi01kcfv4mgsxbjv;
alter table org_chart.GROUPS drop constraint FK_an1wqwxlp48u2nhsxyxpqpq90;
alter table org_chart.INDICATOR_BOOKS drop constraint FK_pfm9eiopb2x9m98632ew8tjba;
alter table org_chart.ORGANIZATIONS drop constraint FK_rxfincph55ifdbn5pv5sb8k7m;
alter table org_chart.ORGANIZATIONS drop constraint FK_katvnhu2dv2bryrmhuk8vlil1;
alter table org_chart.POSITIONS drop constraint FK_60dekt07ij9v4tsj1rpg3n185;
alter table org_chart.POSITIONS drop constraint FK_mkwxwf31usuq3s2m0wfwfocsr;
alter table org_chart.POSITIONS drop constraint FK_f4vawjhyciif1sd69nopx4g74;
alter table org_chart.POSITION_ROLES drop constraint FK_2jow21rb14ivq0k8msh5u1cf9;
alter table org_chart.POSITION_ROLES drop constraint FK_1fssiew82g1t0dbdu5bkt12ff;
alter table org_chart.POSITION_USER_ASSIGNMENTS drop constraint FK_s08ac82lojq2m5x62oyj3fikb;
alter table org_chart.POSITION_USER_ASSIGNMENTS drop constraint FK_2ggvu2iih3yua3aoiinvep90w;
alter table org_chart.PUA_GROUP_ASSIGNMENTS drop constraint FK_cmf33okndiko2dld592rvyhpd;
alter table org_chart.PUA_GROUP_ASSIGNMENTS drop constraint FK_qk8cyr146650au0uayy17le0q;
alter table org_chart.ROLE_FEATURES drop constraint FK_23kfmjd6lt9jgjcxsgp8nmtbp;
alter table org_chart.ROLE_FEATURES drop constraint FK_iyd1dkloxejnurxgx72c9pwvg;
alter table org_chart.TAGS drop constraint FK_k6wd2f0s3fj0okb6r30yl3ri3;
alter table org_chart.TAGS drop constraint FK_ipevg2e11svs427otgyq9us7h;
alter table org_chart.TAGS drop constraint FK_pxva0vfaqwtgcxkgsfdde0hpd;
alter table org_chart.THEMES drop constraint FK_da48w453q5kkg2i9pj83ddoug;
alter table org_chart.TRACKING_NUMBERS drop constraint FK_inwbguqo77jt8dtiddpug1vqe;
alter table org_chart.USERS drop constraint FK_b8wg50ku8xc27xw7llss5m4tx;
alter table org_chart.USERS drop constraint FK_k3gm4drnorissx5s1hmnk99cj;
alter table org_chart.USERS drop constraint FK_i9sqh1870x1j9wgu3s4glweuy;
alter table org_chart.USER_ROLES drop constraint FK_4vocb5yb32s4kl5a9hax6h4sa;
alter table org_chart.USER_ROLES drop constraint FK_ixvn2eap6pna97ymmcm11narh;
...
drop table if exists org_chart.AUTH_USERS cascade;
drop table if exists org_chart.EXTERNAL_ORGANIZATIONS cascade;
drop table if exists org_chart.EXTERNAL_ORGANIZATION_MEMBERS cascade;
drop table if exists org_chart.FEATURES cascade;
drop table if exists org_chart.GROUPS cascade;
drop table if exists org_chart.INDICATOR_BOOKS cascade;
drop table if exists org_chart.ORGANIZATIONS cascade;
drop table if exists org_chart.POSITIONS cascade;
drop table if exists org_chart.POSITION_ROLES cascade;
drop table if exists org_chart.POSITION_USER_ASSIGNMENTS cascade;
drop table if exists org_chart.PUA_GROUP_ASSIGNMENTS cascade;
drop table if exists org_chart.ROLES cascade;
drop table if exists org_chart.ROLE_FEATURES cascade;
drop table if exists org_chart.TAGS cascade;
drop table if exists org_chart.THEMES cascade;
drop table if exists org_chart.TRACKING_NUMBERS cascade;
drop table if exists org_chart.USERS cascade;
drop table if exists org_chart.USER_ROLES cascade;
...
key (id));
create table org_chart.AUTH_USERS (id bigint not null, extuid varchar(255) not null, username varchar(255)
...
key (id));
create table org_chart.EXTERNAL_ORGANIZATIONS (id bigint not null, organizationId bigint not null, extuid
varchar(255) not null, title varchar(255) not null, enabled boolean default true not null, parentId bigint,
primary key (id));
create table org_chart.EXTERNAL_ORGANIZATION_MEMBERS (id bigint not null, extuid varchar(255) not null,
name varchar(255), position varchar(255), postfix varchar(255), prefix varchar(255), displayName varchar(255),
externalOrganisationMemberId bigint, primary key (id));
create table org_chart.FEATURES (id bigint not null, extuid varchar(255) not null, name varchar(255) not
null, description varchar(255), exposable boolean not null, primary key (id));
create table org_chart.GROUPS (id bigint not null, organizationId bigint, extuid varchar(255) not null,
name varchar(255) not null, userId bigint, primary key (id));
create table org_chart.INDICATOR_BOOKS (id bigint not null, extuid varchar(255) not null, organizationId
bigint, name varchar(255) not null, format varchar(255) not null, counter bigint default 1 not null, enabled
boolean default true not null, primary key (id));
create table org_chart.ORGANIZATIONS (id bigint not null, extuid varchar(255) not null, name varchar(255)
not null, code varchar(255), parentId bigint, logo varchar(255), defaultTheme bigint, primary key (id));
create table org_chart.POSITIONS (id bigint not null, extuid varchar(255) not null, organizationId bigint
not null, name varchar(255) not null, parentId bigint, currentUserId bigint, typeKey varchar(255), systemKey
varchar(255), systemDefined boolean not null, primary key (id));
create table org_chart.POSITION_ROLES (roleId bigint not null, positionId bigint not null, primary key
(positionId, roleId));
create table org_chart.POSITION_USER_ASSIGNMENTS (id bigint not null, extuid varchar(255) not null, positionId
bigint not null, userId bigint not null, startTime timestamp not null, finishTime timestamp, primary key
(id));
create table org_chart.PUA_GROUP_ASSIGNMENTS (id bigint not null, extuid varchar(255) not null, groupId
bigint not null, puaId bigint not null, startTime timestamp not null, finishTime timestamp, primary key
(id));
create table org_chart.ROLES (id bigint not null, type_ varchar(255) not null, extuid varchar(255) not
null, name varchar(255) not null, description varchar(255), userDefined boolean not null, systemAdministrative
boolean default false not null, primary key (id));
create table org_chart.ROLE_FEATURES (roleId bigint not null, featureId bigint not null, primary key (roleId,
featureId));
create table org_chart.TAGS (id bigint not null, extuid varchar(255) not null, organizationId bigint,
name varchar(255) not null, parentId bigint, userId bigint, primary key (id));
create table org_chart.THEMES (id bigint not null, extuid varchar(255) not null, title varchar(255) not
null, style_key varchar(255) not null, organizationId bigint, primary key (id));
create table org_chart.TRACKING_NUMBERS (id bigint not null, number varchar(255), counter bigint not null,
indicatorBookId bigint not null, primary key (id));
create table org_chart.USERS (id bigint not null, extuid varchar(255) not null, organizationId bigint,
authUserId bigint not null, enabled boolean not null, userDefined boolean not null, signature varchar(255),
avatar varchar(255), nationalCode varchar(255), themeId bigint, primary key (id));
create table org_chart.USER_ROLES (userId bigint not null, roleId bigint not null, primary key (userId,
roleId));
...
alter table org_chart.AUTH_USERS add constraint UK_3p67nqhndt0u9sakus3uovc81  unique (extuid);
alter table org_chart.AUTH_USERS add constraint UK_j7p9yectkf7l4mp4hqjjsphde  unique (username);
alter table org_chart.EXTERNAL_ORGANIZATIONS add constraint UK_e7ipc259b52hpn0suekyqa6g3  unique (extuid);
alter table org_chart.EXTERNAL_ORGANIZATION_MEMBERS add constraint UK_axiqq82r9fyii0a7bjdq9385m  unique
(extuid);
alter table org_chart.FEATURES add constraint UK_c8pkbrgxfl8ghr7b75hqr8eqv  unique (extuid);
alter table org_chart.FEATURES add constraint UK_qx1jf10esv72lwsb4d8xmbyh8  unique (name);
alter table org_chart.GROUPS add constraint uk_group_organization_name_user  unique (organizationId, name,
userId);
alter table org_chart.GROUPS add constraint UK_b1bslo8i10uiuudfgubun4ysa  unique (extuid);
alter table org_chart.INDICATOR_BOOKS add constraint uk_indicatorBook_organization_name  unique (organizationId,
name);
alter table org_chart.INDICATOR_BOOKS add constraint UK_93ineuf36xsb309ish95vd317  unique (extuid);
alter table org_chart.ORGANIZATIONS add constraint UK_3c6etu4hcxipljwa3jrjdqpxe  unique (extuid);
alter table org_chart.POSITIONS add constraint uk_position_organization_name  unique (organizationId,
name);
alter table org_chart.POSITIONS add constraint UK_faqxdmy6ojsqi4ag3338vms85  unique (extuid);
alter table org_chart.POSITIONS add constraint UK_s80kqpw9ra1713mv4xc3s2jvn  unique (systemKey);
alter table org_chart.POSITION_USER_ASSIGNMENTS add constraint UK_swmw62del0b9fdnx3om95lvwl  unique (extuid);
alter table org_chart.PUA_GROUP_ASSIGNMENTS add constraint UK_6f06faw3vx4bsnbc7krpi5hbf  unique (extuid);
alter table org_chart.ROLES add constraint UK_hffrgdy49ff56f4w6t6pmj288  unique (extuid);
alter table org_chart.ROLES add constraint UK_1s6p3xpt8owdb603jky0mo815  unique (name);
alter table org_chart.TAGS add constraint uk_tag_organization_name  unique (organizationId, name);
alter table org_chart.TAGS add constraint uk_tag_user_name  unique (name, userId);
alter table org_chart.TAGS add constraint UK_rm25nlf3jvl3q3a03s3bdish3  unique (extuid);
alter table org_chart.THEMES add constraint UK_244l13iwpybklvcvam1a8vjj5  unique (extuid);
alter table org_chart.TRACKING_NUMBERS add constraint uk_letterNumber_counter_indicatorBook  unique (counter,
indicatorBookId);
alter table org_chart.USERS add constraint UK_46kvy05nqwkhpefsagvg5samv  unique (extuid);
alter table org_chart.USERS add constraint UK_k3gm4drnorissx5s1hmnk99cj  unique (authUserId);
...
commons_cm.TOPICS;
alter table org_chart.EXTERNAL_ORGANIZATIONS add constraint FK_ntxniwm3lhdo5p3h5aexe5oke foreign key (organizationId)
references org_chart.ORGANIZATIONS;
alter table org_chart.EXTERNAL_ORGANIZATIONS add constraint FK_98axcpe1doxdnqxctxuv3e0r5 foreign key (parentId)
references org_chart.EXTERNAL_ORGANIZATIONS;
alter table org_chart.EXTERNAL_ORGANIZATION_MEMBERS add constraint FK_31xwmqptsbxmi014lhonmhvye foreign
key (externalOrganisationMemberId) references org_chart.EXTERNAL_ORGANIZATIONS;
alter table org_chart.GROUPS add constraint FK_owwl9qyccsi01kcfv4mgsxbjv foreign key (organizationId)
references org_chart.ORGANIZATIONS;
alter table org_chart.GROUPS add constraint FK_an1wqwxlp48u2nhsxyxpqpq90 foreign key (userId) references
org_chart.USERS;
alter table org_chart.INDICATOR_BOOKS add constraint FK_pfm9eiopb2x9m98632ew8tjba foreign key (organizationId)
references org_chart.ORGANIZATIONS;
alter table org_chart.ORGANIZATIONS add constraint FK_rxfincph55ifdbn5pv5sb8k7m foreign key (parentId)
references org_chart.ORGANIZATIONS;
alter table org_chart.ORGANIZATIONS add constraint FK_katvnhu2dv2bryrmhuk8vlil1 foreign key (defaultTheme)
references org_chart.THEMES;
alter table org_chart.POSITIONS add constraint FK_60dekt07ij9v4tsj1rpg3n185 foreign key (organizationId)
references org_chart.ORGANIZATIONS;
alter table org_chart.POSITIONS add constraint FK_mkwxwf31usuq3s2m0wfwfocsr foreign key (parentId) references
org_chart.POSITIONS;
alter table org_chart.POSITIONS add constraint FK_f4vawjhyciif1sd69nopx4g74 foreign key (currentUserId)
references org_chart.USERS;
alter table org_chart.POSITION_ROLES add constraint FK_2jow21rb14ivq0k8msh5u1cf9 foreign key (positionId)
references org_chart.POSITIONS;
alter table org_chart.POSITION_ROLES add constraint FK_1fssiew82g1t0dbdu5bkt12ff foreign key (roleId)
references org_chart.ROLES;
alter table org_chart.POSITION_USER_ASSIGNMENTS add constraint FK_s08ac82lojq2m5x62oyj3fikb foreign key
(positionId) references org_chart.POSITIONS;
alter table org_chart.POSITION_USER_ASSIGNMENTS add constraint FK_2ggvu2iih3yua3aoiinvep90w foreign key
(userId) references org_chart.USERS;
alter table org_chart.PUA_GROUP_ASSIGNMENTS add constraint FK_cmf33okndiko2dld592rvyhpd foreign key (groupId)
references org_chart.GROUPS;
alter table org_chart.PUA_GROUP_ASSIGNMENTS add constraint FK_qk8cyr146650au0uayy17le0q foreign key (puaId)
references org_chart.POSITION_USER_ASSIGNMENTS;
alter table org_chart.ROLE_FEATURES add constraint FK_23kfmjd6lt9jgjcxsgp8nmtbp foreign key (featureId)
references org_chart.FEATURES;
alter table org_chart.ROLE_FEATURES add constraint FK_iyd1dkloxejnurxgx72c9pwvg foreign key (roleId) references
org_chart.ROLES;
alter table org_chart.TAGS add constraint FK_k6wd2f0s3fj0okb6r30yl3ri3 foreign key (organizationId) references
org_chart.ORGANIZATIONS;
alter table org_chart.TAGS add constraint FK_ipevg2e11svs427otgyq9us7h foreign key (parentId) references
org_chart.TAGS;
alter table org_chart.TAGS add constraint FK_pxva0vfaqwtgcxkgsfdde0hpd foreign key (userId) references
org_chart.USERS;
alter table org_chart.THEMES add constraint FK_da48w453q5kkg2i9pj83ddoug foreign key (organizationId)
references org_chart.ORGANIZATIONS;
alter table org_chart.TRACKING_NUMBERS add constraint FK_inwbguqo77jt8dtiddpug1vqe foreign key (indicatorBookId)
references org_chart.INDICATOR_BOOKS;
alter table org_chart.USERS add constraint FK_b8wg50ku8xc27xw7llss5m4tx foreign key (organizationId) references
org_chart.ORGANIZATIONS;
alter table org_chart.USERS add constraint FK_k3gm4drnorissx5s1hmnk99cj foreign key (authUserId) references
org_chart.AUTH_USERS;
alter table org_chart.USERS add constraint FK_i9sqh1870x1j9wgu3s4glweuy foreign key (themeId) references
org_chart.THEMES;
alter table org_chart.USER_ROLES add constraint FK_4vocb5yb32s4kl5a9hax6h4sa foreign key (roleId) references
org_chart.ROLES;
alter table org_chart.USER_ROLES add constraint FK_ixvn2eap6pna97ymmcm11narh foreign key (userId) references
org_chart.USERS;
