...
create table org_chart.POSITION_ROLES (positionId bigint not null, roleId bigint not null, primary key
(positionId, roleId));
...
create table org_chart.USER_ROLES (roleId bigint not null, userId bigint not null, primary key (userId,
roleId));
